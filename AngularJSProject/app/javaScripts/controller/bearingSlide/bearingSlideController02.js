...
controller("bearingSlideController02",function ($scope,$state,$stateParams,orderService) {
    console.log("bearingSlideController02");
    $scope.productDetail = {
        productName : "3 Level Wide Rail",
        imgsrc : "resources/ball02.png",
        defaultPrice : 3500,
        optionedPrice : 0,
        productCode :   '-------',
        originCountry : 'China',
