...
controller("drawerSlide01",function ($scope,$state,$stateParams,orderService) {
    console.log("drawerSlide01");
    $scope.productDetail = {
        productName : "Silence Self Drawer Rail",
        imgsrc : "resources/drawer01.png",
        defaultPrice : 3500,
        optionedPrice : 0,
        productCode :   '-------',
        originCountry : 'China',
